...
static void readArgs(int argc, char *argv[], int32_t *nlr, int32_t *nla, int32_t *noffset, double *squint, char **parFile,
					 ...
					 int32_t *surveyFlag, float *lambda);
static void usage();
...
static void readArgs(int argc, char *argv[], int32_t *nlr, int32_t *nla, int32_t *noffset, double *squint, char **parFile,
					 char **geodatFile, int32_t *passType, double *lookDir, int32_t *squintTime, int32_t *ersFix, int32_t *surveyFlag, float *lambda)
{
	int32_t i;
	if (argc < 9 || argc > 13)
