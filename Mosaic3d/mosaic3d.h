...
*/
void writeTieFile( outputImageStructure *outputImage, xyDEM *dem, xyDEM *vzCorrect, char *outFile, double tieThresh, char *extraTieFile, char *tideFile, int autoSize);
/*
